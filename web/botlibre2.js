...
function WebLiveChatListener() {
	...
	this.users = {};
	/** Displaying advanced info to the user. */
	this.showAdvancedInfo;
	...
	this.createBox = function() {
		...
		if (this.background != null) {
			backgroundstyle = " style='background-color:" + "black" + "'";
			hidden = "visible";
	...
	this.updateUsersXML = function(usersXML) {
		...
		if (this.onlineBar) {
			...
			// Set bar to 2nd user, which is operator/bot
			if (children.length > 1) {
				var child = children[1];
				onlineBar.appendChild(child);
			}
			return;
		}
...
function WebChatbotListener() {
	...
	this.backgroundIfNotChrome = true;
	...
	this.createBox = function() {
		...
		var html =
			"<style>\n"
				...
				+ (this.forceStyles ? "#" : ".") + this.prefix + "chat { width:99%;min-height:22px; }\n"
				+ "." + this.prefix + "box-input-span { display:block; overflow:hidden; margin:4px; padding-right:4px; }\n"
				+ "#" + this.prefix + "boxtable { background-image:url(\"accenture_!.jpg\"); border:none; margin:0; }\n"
				+ this.style
			+ "</style>\n"
			+ "<div id='" + this.prefix + "box' class='" + this.prefix + "box' " + backgroundstyle + ">"
				+ "<div class='" + this.prefix + "boxmenu'>"
		...
		html = html
			...
			+ "<img id='" + this.prefix + "boxlanguage' class='" + this.prefix + "boxbutton' src='" + urlprefix + "/images/language.png'>"
			+ "</span>";
		if (this.allowSpeech) {
			html = html
